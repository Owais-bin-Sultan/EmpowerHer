      ...
      <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <ul className='flex gap-5 text-sm text-gray-200'>
          ...
          {isLoggedIn ? (
            ...
            <li><Link to='/learning' className='hover:text-white'>Training</Link></li>
              <li><Link to="/cart" className="hover:text-white">
                <img src={assets.cart_icon} className='w-5' alt="Cart" />
              </Link></li>
              <li><Link to="/profile" className="hover:text-white">
                <img src={assets.profile_icon} className='w-5' alt="Profile" />
              </Link></li>
              <li><button onClick={onLogout} className="hover:text-white">Logout</button></li>
            </>
          ) : (
            <>
